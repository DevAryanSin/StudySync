                    ...
                    <div className="border border-slate-200 rounded-lg bg-white shadow-sm overflow-hidden flex flex-col h-96">
                        ...
                        <form onSubmit={handleChat} className="border-t border-slate-200 p-3 flex gap-2 bg-white">
                            <input
                                ...
                                disabled={loading}
                                className="flex-1 p-2 text-sm border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-slate-100 bg-gray-100 text-black"
                            />
                            <button
                                type="submit"
